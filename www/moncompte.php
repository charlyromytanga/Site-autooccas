...
<head>
    ...
    <link rel="stylesheet" href="../www/scr/javascript/bootstrap.bundle.min.js">
</head>
<body>
    ...
    <header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar">
        <div class="navbar-nav-scroll">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.phps" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Bootstrap');">Acceuil</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Icons');">Mon comptre</a>
            </li>
            <li class="nav-item">
